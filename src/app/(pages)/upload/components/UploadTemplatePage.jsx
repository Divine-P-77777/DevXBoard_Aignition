        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          ...
          >
            ...
            <p>
              ...
              {initialData && initialData.id ? "update" : "submit"} this template?
            </p>
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Share your code snippets & templates with the community. Make it
            public or keep it private.
          </p>

          <div className="space-y-2">
            <RectangleCloudinary onUpload={(url) => setImage(url)} initialUrl={image} />
            {image && (
          ...
          {/* ✅ Updated to pass usernames instead of emails */}
          <VisibilitySection
            visibility={visibility}
