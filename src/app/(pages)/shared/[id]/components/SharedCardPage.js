...
const SharedCardPage = ({ id }) => {
  ...
  if (!card) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-purple-950 via-fuchsia-900 to-black text-center px-6">
      <div className="max-w-md">
        ...
        <p className="text-lg text-gray-300 mb-8">
          The card you’re looking for is either <span className="text-pink-400 font-semibold">private</span> or doesn’t exist.
        </p>

        {/* Action button */}
        <a
          href="/"
          className="inline-block bg-gradient-to-r border from-pink-600 to-purple-600 hover:from-purple-600 hover:to-pink-600 text-white font-medium px-6 py-3 rounded-full transition-transform transform hover:scale-105 shadow-lg"
        >
          Go Back Home
        </a>
      </div>
